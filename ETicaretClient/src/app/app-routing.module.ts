...
const routes: Routes = [
  {
    path: "admin", component: LayoutComponent, children: [
      {path:"",component: DashboardComponent},//adminden sonra default olarak gidecek yol "path i boş verip gitmesinin istediğimiz component i belirtiyoruz"
  ...
  {path:"", component:HomeComponent}, //sisteme ilk girişte karşılayacak ilk sayfa "path i boş verip gitmesinin istediğimiz component i belirtiyoruz."
